...
Our team goals for this project are to work collaboratively, meet deadlines, and learn how to troubleshoot, create our own code, and develop analytical skills by working together. 

-   What do you want to accomplish? What skills do you want to develop or refine?

We hope to accomplish creating a comprehensive statistical analysis portfolio of a dataset. We would like to develop our R coding skills, statistical analysis skills, and data analytic critical thinking. 
...
We plan to meet Saturdays at 9 am.
...
-   Meeting location: Identify how or where the team will meet to work together (e.g. in-person, Zoom, Facetime, Google Hangouts). Be sure every member is able to access the in-person and/or virtual meeting space.
 ...
 We plan to meet in Craven D common room. 
...
We have created a text message groupchat. All communications will be via this text message groupchat. 
...
Please notify team members via messages if you cannot make it. 
...
Everyone should have their portion completed by Sunday night so we can review it on Monday morning. 

-   How should team members communicate if they're struggling with the portion of the work assigned to them?

Reach out via the messages groupchat and let us know what you are struggling with. 

# Policies & procedures

What rules can you agree on to help you meet your goals and expectations?

We believe that everyone should contribute equally, attend meetings as much as possible, be active listeners, and not fall behind on deadlines. 

# Consequences

How will you address non-performance in regard to these goals, expectations, policies and procedures?

We will talk to each other in the groupchat and reach out if things are not going well. 
...
Team member name: Srilakshmi Venkatesan

Team member name: Ryan Lee

Team member name: Daniel Murong

Team member name: Sriya Sridhar
