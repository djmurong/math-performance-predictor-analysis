...
ggplot(
  ...
  labs(
    title = "Relationship Between Final Grade and\nNumber of Past Class Failures",
...
@fig-g3-studytime reveals a slight increase in the typical final grade as amount of study time increase, although not substantial enough to be among the strongest factors.
...
edu_achievement |>
  ...
  ggplot(
    ...
    geom_boxplot(alpha = 0.7) +
    labs(
      title = "Relationship Between Final Grade and Study Time",
...
@fig-medu displays how there is a variable trend of student performance in regards to parent education level. The median final grade for students whose parent has no education is higher than the rest, but there are only a few points of data that that category, making the pattern difficult to confirm. Nonetheless, the trend is not strong enough to be considered one of the strongest factors of student performance.
