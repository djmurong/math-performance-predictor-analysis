...
@fig-g3-failures-plot highlights differences in medians of students' final grades across the number of past class fails they have.
```{r}
#| label: fig-g3-failures-plot
